...
<!--
	...
	{
		window.resizeTo(window.screen.availWidth/3, window.screen.availHeight/3);
	}
	function fermer()
	{
		window.close(); 
...
<table width="85%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#D3D1FA"> 
  ...
  <tr> 
    <td align="center"><EMBED src="F:\MP3 Techno\<%=URL%>" autostart=true loop=infinite volume=100% show=true></td> 
  </tr> 
  <tr> 
